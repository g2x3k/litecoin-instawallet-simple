<?
// deprecated page ... new vault.php
$address = "vault?key=" . $_GET["key"];
...
<br>
<center><a href=http://wallet.it.cx/vault?key={$_GET['key']} style=\"font-size: 12px;\">http://wallet.it.cx/address?key={$_GET['key']}</a> (ctrl+b to bookmark)</center>");
